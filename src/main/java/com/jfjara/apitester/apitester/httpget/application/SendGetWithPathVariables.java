...
@Service
public class SendGetWithPathVariables extends SendGetAbstract {
    ...
    public Optional<String> send(Map<String, String[]> parameterMap)
            ...
            CommunicationException, UnsupportedEncodingException {
        ...
        for (int i = 0; i < parametersGroup.getTotalRequestToDo(); i++) {
            optionalsResult.add(communicator.get(parametersGroup.getUrlWithPathVariables()));
        }
